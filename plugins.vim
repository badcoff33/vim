...
def g:Config_T01()
  command! -nargs=0 CtagsUpdate Ctags -R NvmDriverT01 DemoAppT01
...
def g:Config_T02()
  command! -nargs=0 CtagsUpdate Ctags -R NvmDriverT02 DemoAppT02
...
def g:Config_T0X()
  command! -nargs=0 CtagsUpdate Ctags -R NvmDriverT02 NvmDriverT01 DemoUscT0X
