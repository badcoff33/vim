...
execute 'hi Comment' s:GuiFg(s:silver6)
...
execute 'hi WarningMsg' s:GuiFg(s:silver0) s:GuiBg(s:silver7)
execute 'hi ModeMsg' s:GuiFg(s:silver0) s:GuiBg(s:silver7)
execute 'hi Question' s:GuiFg(s:silver1) s:GuiBg('bg')
execute 'hi qfFileName' s:GuiFg(s:blue)
execute 'hi qfSeparator' s:GuiFg(s:silver1)
...
" filetype HTML
execute 'hi htmlH1' s:GuiFg(s:silver2)  s:GuiAttr('bold')
execute 'hi htmlH2' s:GuiFg(s:silver2)  s:GuiAttr('bold')
execute 'hi htmlH3' s:GuiFg(s:silver2)  s:GuiAttr('bold')
