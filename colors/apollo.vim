...
execute "hi IncSearch" Fg(black) Bg(green) Attr("NONE") Cterm("NONE")
...
execute "hi Pmenu" Fg(white) Bg(blue_dk) Attr("NONE")
execute "hi PmenuSbar" Fg(fg[2]) Bg(bg[2])
execute "hi PmenuSel" Fg(white) Bg(green) Attr("NONE")
execute "hi PmenuThumb" Fg(blue) Bg(bg[3])
...
execute "hi User1" Fg(white) Bg(green) Attr("NONE")
