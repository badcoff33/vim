...
execute "hi CurSearch" Fg(black) Bg(green_dk) Bold
execute "hi Cursor" Fg(black) Bg(white)
execute "hi Conceal"  Bg(bg0) Fg(blue) Normal
execute "hi CursorLine"  Bg(bg1) Normal
execute "hi CursorLineNr" Fg(green) Bg(bg2) Normal
execute "hi ErrorMsg" Fg(red) Bg("bg")
execute "hi IncSearch" Fg(black) Bg(white) Normal
execute "hi Italic" Fg(fg1)  Normal
execute "hi LineNr" Fg(blue_lt) Bg(bg0) Normal
...
execute "hi PmenuSel" Fg(white) Bg(green_dk) Bold
...
execute "hi Search" Fg(white) Bg(green_dk) Normal
execute "hi StatusLine" Fg(white) Bg(bg3) Normal
execute "hi StatusLineNC" Fg(white) Bg(bg1) Normal
...
execute "hi TabPanelSel" Fg(white) Bg("bg") Normal
execute "hi Terminal" Fg(fg3) Bg(bg0)
execute "hi Title" Fg(green_lt)
execute "hi User1" Fg(green) Bg(bg3) Normal
execute "hi User2" Fg(sun) Bg(bg3)
execute "hi VertSplit" Fg(bg1) Bg(bg2) Normal
execute "hi Visual" Fg(white) Bg(green_dk)
execute "hi WarningMsg" Fg(black) Bg(sun)
