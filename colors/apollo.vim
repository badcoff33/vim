...
execute "hi IncSearch" s:Fg(s:black) s:Bg(s:white) s:Attr("bold") s:Cterm("NONE")
...
execute "hi PmenuSel" s:Fg(s:white) s:Bg(s:green_bg) s:Attr("NONE")
...
execute "hi StatusLine" s:Fg(s:white) s:Bg(s:blue1) s:Attr("NONE") s:Cterm("NONE")
execute "hi StatusLineNC" s:Fg(s:silver4) s:Bg(s:bg3) s:Attr("NONE") s:Cterm("NONE")
execute "hi Terminal" s:Fg(s:green3) s:Bg(s:black)
