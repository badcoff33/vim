...
call lib#color#Hi('StatusLine', s:grey_1, s:grey_5, 'none', '')
call lib#color#Hi('StatusLineNC', s:grey_2, s:grey_6, 'none', '')
call lib#color#Hi('VertSplit', s:grey_6, s:grey_8, 'NONE', '')
call lib#color#Hi('IncSearch', s:orange_9, s:orange_6, 'none', '')
call lib#color#Hi('Search', s:orange_1, s:orange_7, 'NONE', '')
