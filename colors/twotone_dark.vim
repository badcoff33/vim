...
execute "hi CursorLine" Bg(gray[1]) Cterm("NONE")
execute "hi CursorLineNr" Fg(gray[6]) Attr("bold")
execute "hi Folded" Fg(blue) Bg(gray[8]) Attr("NONE")
execute "hi IncSearch" Fg(red_lt) Bg(red_dk) Attr("NONE")
...
execute "hi Normal" Fg(gray[7]) Bg(black) Attr("NONE")
...
execute "hi Search" Fg(blue_lt) Bg(gray[2]) Attr("NONE")
execute "hi StatusLine" Fg(white) Bg(blue_dk) Attr("NONE")
execute "hi StatusLineNC" Fg(white) Bg(gray[2]) Attr("NONE")
