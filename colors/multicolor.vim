...
execute "hi Cursor" Fg(s:yellow[5]) Bg(s:blue[8])
...
execute "hi PreCondit" Fg(s:blue[6])  Attr("bold")
execute "hi Define" Fg(s:blue[8])  Attr("NONE")
execute "hi Comment" Fg(s:green[4])
execute "hi Function" Fg(s:blue[8]) Attr("bold")
execute "hi Identifier" Fg(s:gray[4])
